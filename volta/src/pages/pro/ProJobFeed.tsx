...
const JOBS = [
  {
    ...
    posted: "2 hours ago",
    tag: "Plumbing", tagColor: "bg-blue-50 text-blue-600",
    urgent: true,
    budget: "KSh 2,500",
  },
  {
    ...
    posted: "4 hours ago",
    tag: "Electrical", tagColor: "bg-blue-50 text-blue-600",
    urgent: false,
    budget: "KSh 3,000",
  },
  {
    ...
    posted: "6 hours ago",
    tag: "Cleaning", tagColor: "bg-green-50 text-green-600",
    urgent: false,
    budget: "KSh 4,000",
  },
  {
    ...
    posted: "8 hours ago",
    tag: "Painting", tagColor: "bg-pink-50 text-pink-600",
    urgent: false,
    budget: "KSh 5,000",
  },
];
...
const STATS = [
  { emoji: "💼", value: "28", label: "Available Jobs",  sub: "Total open jobs",   bg: "bg-green-50" },
  { emoji: "🕐", value: "6",  label: "New Today",       sub: "Jobs posted today", bg: "bg-orange-50" },
  { emoji: "✅", value: "3",  label: "Applied",         sub: "Jobs you applied",  bg: "bg-purple-50" },
    ...
    <div className="min-h-screen bg-gray-50 font-sans flex flex-col">
      ...
      <main className="flex-1 max-w-screen-xl mx-auto w-full px-4 py-5 flex flex-col gap-4">
        ...
        <div className="flex gap-3">
          <div className="flex-1 flex items-center gap-2 bg-white border border-gray-200 rounded-xl px-4 py-3 focus-within:border-green-400 transition-colors">
          ...
          <button className="flex items-center gap-2 border border-gray-200 bg-white text-gray-700 font-semibold text-sm px-4 py-3 rounded-xl hover:bg-gray-50 transition-colors">
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-1 scrollbar-hide">
          {CATEGORIES.map((cat, i) => (
            <button key={cat.label} className={`flex items-center gap-1.5 whitespace-nowrap px-4 py-2 rounded-full text-sm font-semibold transition-colors flex-shrink-0 ${
          ...
          <button className="flex items-center gap-1 whitespace-nowrap px-4 py-2 rounded-full text-sm font-semibold border border-gray-200 bg-white text-gray-600 hover:bg-gray-50 transition-colors flex-shrink-0">
          ...
          <div className="flex-1 min-w-0 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              {JOBS.map(job => (
                <div key={job.title} className="bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-md transition-shadow">
                  <div className="flex">
                    {/* Image thumbnail */}
                    <div className={`${job.bg} w-48 flex-shrink-0 flex items-center justify-center text-5xl`}>
                      {job.emoji}
                    </div>
                    {/* Content */}
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-4 flex-wrap">
                            ...
                            <div className="flex items-center gap-1 text-xs text-gray-400">
                              <Calendar className="w-3 h-3 flex-shrink-0" /> Posted {job.posted}
                            </div>
                        ...
                        <div className="flex flex-col items-end gap-2 flex-shrink-0">
                          ...
                          <button className="bg-green-600 hover:bg-green-700 text-white font-semibold text-xs px-5 py-2 rounded-xl transition-colors w-full">
                            View Details
                          </button>
                          <button className="flex items-center gap-1 text-xs text-gray-400 hover:text-green-600 transition-colors mt-0.5">
            ...
            <div className="flex items-center justify-between py-2">
              ...
              <div className="flex items-center gap-1.5">
                <button className="p-1.5 border border-gray-200 rounded-lg hover:bg-gray-50 disabled:opacity-40 transition-colors" disabled>
                  <ChevronRight className="w-4 h-4 text-gray-500 rotate-180" />
                </button>
                {[1,2,3].map(n => (
                  <button key={n} className={`w-8 h-8 rounded-lg text-sm font-semibold transition-colors ${n === 1 ? "bg-green-600 text-white" : "border border-gray-200 text-gray-600 hover:bg-gray-50"}`}>{n}</button>
                ))}
                <button className="p-1.5 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                  <ChevronRight className="w-4 h-4 text-gray-500" />
                </button>
                <select className="ml-2 border border-gray-200 rounded-lg text-xs text-gray-600 px-2 py-1.5 outline-none bg-white">
          ...
          <div className="w-72 flex-shrink-0 hidden lg:flex flex-col gap-4">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-4">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-1.5">
                  ...
                  <p className="font-bold text-gray-900 text-sm">Recommended for you</p>
                </div>
                <button className="text-xs font-semibold text-green-600 hover:text-green-700">View all</button>
              </div>
              <div className="flex flex-col gap-2">
                {RECOMMENDED.map(r => (
                  <div key={r.title} className="flex items-center gap-3 p-2.5 rounded-xl hover:bg-gray-50 transition-colors cursor-pointer group">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                <p className="font-bold text-gray-900 text-sm">Pro Tips</p>
              </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className="font-bold text-gray-900 text-sm">Never miss a job!</p>
              </div>
