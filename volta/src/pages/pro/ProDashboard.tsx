    ...
    <div className="min-h-screen bg-gray-50 font-sans flex flex-col">
      ...
      <main className="flex-1 max-w-screen-xl mx-auto w-full px-4 py-5 flex flex-col gap-5">
        ...
        <div className="flex items-start justify-between">
          ...
          <button className="flex items-center gap-2 border border-gray-200 rounded-xl px-4 py-2 text-sm text-gray-700 bg-white hover:bg-gray-50 transition-colors">
            <Calendar className="w-4 h-4 text-gray-500" />
            <span className="font-medium">May 26 – Jun 1, 2024</span>
