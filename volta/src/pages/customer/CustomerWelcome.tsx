...
export default function CustomerWelcome() {
  const stored = localStorage.getItem("volta_user");
        ...
        <div className="bg-gradient-to-br from-green-600 to-green-700 rounded-2xl p-8 text-white mb-8 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/80 text-sm leading-relaxed max-w-md">
              Your VOLTA account is ready. You can now find and book trusted professionals for any home service in your area.
            </p>
          </div>
        </div>
