...
const BOOKINGS = [
  { img: "https://images.unsplash.com/photo-1585704032915-c3400305e979?w=120&q=70",  title: "Fix Kitchen Sink Leak",     pro: "John Kamau (Plumber)",          location: "Ruiru, Kiambu County", date: "May 22, 2024 • 10:00 AM", status: "Scheduled", statusColor: "bg-blue-100 text-blue-700",   amount: "KSh 1,200", bookingId: "#GF12453" },
  { img: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=120&q=70",  title: "Install Ceiling Lights",     pro: "David Mwangi (Electrician)",    location: "Ruiru, Kiambu County", date: "May 20, 2024 • 2:00 PM",  status: "Pending",   statusColor: "bg-orange-100 text-orange-700", amount: "KSh 2,000", bookingId: "#GF12452" },
  { img: "https://images.unsplash.com/photo-1558317374-067fb5f30001?w=120&q=70",  title: "Sofa Deep Cleaning",         pro: "Mary Wanjiku (Cleaner)",        location: "Ruiru, Kiambu County", date: "May 18, 2024 • 9:00 AM",  status: "Completed", statusColor: "bg-green-100 text-green-700",   amount: "KSh 800",   bookingId: "#GF12451" },
  { img: "https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=120&q=70", title: "House Painting",             pro: "Daniel Mutua (Painter)",        location: "Ruiru, Kiambu County", date: "May 15, 2024 • 11:00 AM", status: "Completed", statusColor: "bg-green-100 text-green-700",   amount: "KSh 5,500", bookingId: "#GF12450" },
  { img: "https://images.unsplash.com/photo-1504309092620-4d0ec726efa4?w=120&q=70", title: "AC Repair & Maintenance",    pro: "Peter Ndungu (HVAC Technician)",location: "Ruiru, Kiambu County", date: "May 12, 2024 • 4:00 PM",  status: "Cancelled", statusColor: "bg-red-100 text-red-600",       amount: "KSh 1,500", bookingId: "#GF12449" },
];
              ...
              {BOOKINGS.map((b, i) => (
                <div key={b.title} className={`p-4 hover:bg-gray-50 transition-colors ${i < BOOKINGS.length - 1 ? "border-b border-gray-50" : ""}`}>
                  ...
                  <div className="flex gap-3 sm:gap-4">
                    <img src={b.img} alt={b.title} className="w-16 h-14 sm:w-20 sm:h-16 rounded-xl object-cover flex-shrink-0" />
                    <div className="flex-1 min-w-0 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                      {/* Info */}
                      <div className="flex-1 min-w-0">
                        <p className="font-bold text-gray-900 text-sm truncate">{b.title}</p>
                        <p className="text-xs text-gray-500 mt-0.5 truncate">👤 {b.pro}</p>
