...
export default function CustomerChats() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans flex flex-col">
      ...
      <div
        className="flex flex-1 max-w-screen-xl mx-auto w-full px-4 py-4 gap-0"
        style={{ height: "calc(100vh - 56px)" }}
      >
        {/* ── LEFT: Conversation list ── */}
        <div
          className={`${mobilePanel === "chat" ? "hidden md:flex" : "flex"} flex-col border border-gray-100 rounded-l-2xl overflow-hidden bg-white flex-shrink-0`}
          style={{ width: 300 }}
        >
          {/* Header */}
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between mt-0.5">
                    <p className="text-xs text-gray-400 truncate max-w-[170px]">{c.sub}</p>
                    {c.unread > 0 && (
                      <span className="w-5 h-5 bg-green-600 text-white text-[10px] font-bold rounded-full flex items-center justify-center flex-shrink-0 ml-1">
                        {c.unread}
                      </span>
                    )}
                  </div>
        ...
        {/* ── MIDDLE: Active chat ── */}
        <div
          className={`${mobilePanel === "list" ? "hidden md:flex" : "flex"} flex-1 flex-col border-t border-b border-gray-100 overflow-hidden bg-white`}
        >
          {/* Chat header */}
          <div className="flex items-center justify-between px-5 py-3.5 border-b border-gray-100 flex-shrink-0">
            <div className="flex items-center gap-3">
              ...
              <div className="relative">
                <img src="https://i.pravatar.cc/80?img=11" alt="John Kamau" className="w-11 h-11 rounded-full object-cover" />
          ...
          <div className="mx-4 mt-4 mb-1 flex-shrink-0">
            <div className="border border-gray-100 rounded-2xl overflow-hidden bg-white shadow-sm">
              <div className="flex items-start gap-3 p-4">
                <img
                  src="https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=120&q=70"
                  alt="sink"
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-1.5 mt-1.5 text-xs text-gray-500">
                    ...
                    <span>May 22, 2024 at 10:00 AM</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between mt-2">
                    ...
                    <button className="border border-gray-200 text-gray-700 font-semibold text-xs px-3 py-1.5 rounded-lg hover:bg-gray-50 transition-colors">
                      View Details
                    </button>
                  </div>
                </div>
          ...
          <div className="flex-1 overflow-y-auto px-4 py-3 flex flex-col gap-3">
            ...
            {MESSAGES.map((m) => (
              <div key={m.id} className={`flex ${m.from === "me" ? "justify-end" : "justify-start"}`}>
                <div className={`max-w-[68%] flex flex-col ${m.from === "me" ? "items-end" : "items-start"}`}>
        ...
        {/* ── RIGHT: Chat Details ── */}
        <div
          className="hidden lg:flex flex-col border border-gray-100 rounded-r-2xl overflow-y-auto bg-white flex-shrink-0"
          style={{ width: 256 }}
        >
          {/* Header */}
          <div className="flex items-center justify-between px-4 py-4 border-b border-gray-100">
          ...
          <div className="px-4 py-4 border-b border-gray-100">
            ...
            <div className="space-y-2.5">
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs font-semibold text-gray-800">Fix Kitchen Sink Leak</p>
                </div>
              </div>
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs font-semibold text-gray-800">May 22, 2024 at 10:00 AM</p>
                </div>
              </div>
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs font-semibold text-gray-800">Ruiru, Kiambu County</p>
                </div>
              </div>
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs font-semibold text-gray-800">KSh 1,200</p>
                </div>
              </div>
              <div className="flex items-start gap-2.5">
            ...
            <button className="mt-4 w-full border border-gray-200 text-gray-700 font-semibold text-xs py-2.5 rounded-xl hover:bg-gray-50 transition-colors">
          ...
          <div className="px-4 py-4 border-b border-gray-100">
            ...
            <div className="flex items-center gap-2.5 p-2.5 bg-gray-50 rounded-xl">
              <img
                src="https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=60&q=60"
                alt="sink"
