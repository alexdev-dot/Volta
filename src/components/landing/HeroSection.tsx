          ...
          <div className="flex-1 max-w-[520px] lg:max-w-none">
            ...
            <div className="flex flex-wrap items-center gap-3 mb-9">
              <button 
                ...
                className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 active:bg-green-800 text-white font-bold px-7 py-3.5 rounded-xl transition-colors shadow-md shadow-green-200 text-sm"
              >
