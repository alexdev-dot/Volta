    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <div className="max-w-screen-xl mx-auto px-4 py-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-5">
          <div>
            <h1 className="text-xl sm:text-2xl font-extrabold text-gray-900">Reviews</h1>
            <p className="text-gray-500 text-sm mt-0.5">See what your customers are saying about your services.</p>
          </div>
          <button className="flex items-center gap-2 border border-gray-200 text-gray-700 font-semibold text-sm px-4 py-2.5 rounded-lg hover:bg-gray-50 transition-colors self-start sm:self-auto flex-shrink-0">
            <Download className="w-4 h-4" /> <span className="hidden sm:inline">Export Reviews</span><span className="sm:hidden">Export</span>
          </button>
        </div>
        ...
        <div className="flex gap-5">
          ...
          <div className="flex-1 min-w-0">
            {/* Search + Filters */}
            <div className="bg-white rounded-2xl border border-gray-100 p-3 sm:p-4 mb-4 flex flex-col sm:flex-row gap-2 sm:gap-3">
              <div className="flex-1 flex items-center gap-2 border border-gray-200 rounded-xl px-3 py-2 focus-within:border-green-400 transition-colors">
                ...
                <input type="text" placeholder="Search reviews..." className="flex-1 text-sm text-gray-700 placeholder-gray-400 outline-none bg-transparent min-w-0" />
              </div>
              <div className="flex items-center gap-2 overflow-x-auto">
                {["All Ratings", "All Services", "All Time"].map((f) => (
                  <div key={f} className="relative flex-shrink-0">
                    <select className="appearance-none border border-gray-200 rounded-xl text-sm text-gray-600 pl-3 pr-7 py-2 outline-none focus:border-green-400 bg-white cursor-pointer">
                      <option>{f}</option>
                    </select>
