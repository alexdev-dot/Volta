      ...
      <main className="flex-1 max-w-screen-xl mx-auto w-full px-4 py-5 flex flex-col gap-5">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 sm:w-10 sm:h-10 bg-green-100 rounded-xl flex items-center justify-center text-xl flex-shrink-0">💰</div>
            <div>
              <h1 className="text-xl sm:text-2xl font-extrabold text-gray-900">Earnings</h1>
              <p className="text-sm text-gray-500">Track your income, payouts and financial performance.</p>
            </div>
          </div>
          <div className="flex items-center gap-2 flex-wrap">
            <button className="flex items-center gap-2 border border-gray-200 bg-white text-sm font-semibold text-gray-700 px-3 sm:px-4 py-2 rounded-xl hover:bg-gray-50 transition-colors flex-shrink-0">
              <Calendar className="w-4 h-4 text-gray-400" />
              <span className="hidden sm:inline">May 26 – Jun 1, 2024</span>
              <span className="sm:hidden">May 26–Jun 1</span>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 sm:gap-3">
          {STATS.map(s => (
            <div key={s.label} className="bg-white rounded-2xl border border-gray-100 p-3 sm:p-4 flex items-start gap-2 sm:gap-3">
              ...
              <div className="min-w-0">
                <p className="text-sm sm:text-base font-extrabold text-gray-900 leading-tight">{s.value}</p>
                ...
                <p className="text-[9px] text-gray-400 mt-0.5 truncate hidden sm:block">{s.sub}</p>
              </div>
            </div>
          ))}
        </div>
