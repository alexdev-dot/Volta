import {
  ...
  MessageCircle, Calendar, Clock, Gift, ShieldCheck, CreditCard, Award, Clock as ClockIcon,
} from "lucide-react";
        ...
        <div className="flex gap-5 lg:gap-6">
          ...
          <div className="flex-1 min-w-0 space-y-4 sm:space-y-5">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
              {[
                { icon: ShieldCheck, title: "Background Checked", desc: "All pros are verified", iconColor: "text-green-600", iconBg: "bg-green-50" },
                { icon: CreditCard, title: "Upfront Pricing",    desc: "No hidden charges", iconColor: "text-blue-600", iconBg: "bg-blue-50" },
                { icon: ClockIcon, title: "On-time Service",    desc: "We respect your time", iconColor: "text-orange-600", iconBg: "bg-orange-50" },
                { icon: Award, title: "Satisfaction Guaranteed", desc: "We've got your back", iconColor: "text-purple-600", iconBg: "bg-purple-50" },
              ].map((t) => (
                <div key={t.title} className="bg-white rounded-xl border border-gray-100 p-3 sm:p-4 flex items-center gap-3">
                  <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-xl ${t.iconBg} flex items-center justify-center flex-shrink-0`}>
                    <t.icon className={`w-5 h-5 sm:w-6 sm:h-6 ${t.iconColor}`} />
                  </div>
